...
Build instructions and implementation details for WavRecorder.
For a short overview of the app, see the [README](../README.md).
...
On Windows, use `gradlew.bat :app:assembleDebug` with `JAVA_HOME` and
